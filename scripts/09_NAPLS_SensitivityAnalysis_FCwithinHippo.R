# SENITIVITY ANALYSIS: CHANGE OF FC PATTERNS WITHIN HIPPOCAMPUS AND CHANGE OF CLINICAL VARIABLES ---------------------------------------------
...
out_dir = "results/napls/P1_HippoFC/09_NAPLS_SensitivityAnalysis_FCwithinHippo/"
...
# export data
write.csv(df_res_stats_full,paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_UnstandardizedResultsSummary_InteractionsBonf_WithinHip.csv"), row.names = FALSE)
write_xlsx(df_res_stats_full,path = paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_UnstandardizedResultsSummary_InteractionsBonf_WithinHip.xlsx"))
...
# export data
write.csv(df_path_hip,file = paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_UnstandardizedResultsSummary_FullStats_WithinHip.csv"), row.names = FALSE)
write_xlsx(df_path_hip,path = paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_UnstandardizedResultsSummary_FullStats_WithinHip.xlsx"))
...
# export data
write.csv(df_res_stats_full,paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_StandardizedResultsSummary_InteractionsBonf_WithinHip.csv"), row.names = FALSE)
write_xlsx(df_res_stats_full,path = paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_StandardizedResultsSummary_InteractionsBonf_WithinHip.xlsx"))
...
df_path_hip[df_path_hip == 999] = NA
# export data
write.csv(df_path_hip,file = paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_StandardizedResultsSummary_FullStats_WithinHip.csv"), row.names = FALSE)
write_xlsx(df_path_hip,path = paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_StandardizedResultsSummary_FullStats_WithinHip.xlsx"))
...
# export data
write.csv(df_modelfit,file = paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_ResultsSummary_ModelFit_WithinHip.csv"), row.names = FALSE)
write_xlsx(df_modelfit, path = paste0(out_dir,"Napls_LatentVariableRegress_Case-Control_ResultsSummary_ModelFit_WithinHip.xlsx"))
